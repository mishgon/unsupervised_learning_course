...
$$ \underset{X \sim p(x), T_1, T_2 \sim \mathcal{T}}{\mathbb{E}}\|f_\theta(T_1(X)) - f_\theta(T_2(X))\|^2

- \lambda \|\text{cov}(Z) - I\|_F^2 \to \min_\theta $$
...
$$ \text{cov}_1 = \frac{1}{n/2 - 1}\sum_{i = 1}^{n/2}Z_iZ_i^T, \quad \text{and} \quad \text{cov}_2 = \frac{1}{n/2 - 1}\sum_{i = n/2 + 1}^{n}Z_iZ_i^T $$
